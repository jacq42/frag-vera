...
interface PantryAddProps {
    onAdded?: () => void;
}

export default function PantryAdd({ onAdded }: PantryAddProps) {
    ...
    const addItem = async () => {
        ...
        try {
            ...
            if (response.ok) {
                setMessage(`✓ ${amount} ${unit.shortName} ${ingredient.name} eingelagert.`);
    ...
    return (
        <div className="pb-8">
            <div className="pb-8">
                ...
                >
                    <option value="">-- Was hast du im Vorrat? --</option>
